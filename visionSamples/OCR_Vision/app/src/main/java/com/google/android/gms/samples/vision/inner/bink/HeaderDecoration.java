 ...
 */
public class HeaderDecoration extends RecyclerView.ItemDecoration  implements View.OnClickListener{
    ...
    private final HeaderDecorationDelegate delegate;

    private final int MARGIN = 32; // This is necessary as the Layout is not accessible within getItemOffset, from mView.getLayoutParams()

    public HeaderDecoration(View view, boolean scrollsHorizontally, float parallax, float shadowSize, int columns, HeaderDecorationDelegate delegate) {
        mView = view;
...
//        mView.setOnTouchListener(this);
        ...
        for (int i = 0; i < parent.getChildCount(); i++) {
            ...
            if (parent.getChildAdapterPosition(view) == 0) {
                ...
                if (mHorizontal) {
                    ...
                    c.clipRect(parent.getLeft(), 0, parent.getRight(), view.getTop());
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        if (parent.getChildAdapterPosition(view) < mColumns) {
            if (mHorizontal) {
                ...
                /*
                This line of code is what causes the recyclerview to be spawned lower down the screen.
                 */
    ...
    public static class Builder {
       public Context mContext;
        ...
        private HeaderDecorationDelegate delegate;

//@Override
//        public void onClickListener(){
//
//            Intent n = new Intent(mContext2, AddPaymentCardManuallyActivity.class);
//            mContext2.startActivity(n);
//
//
//
//        }
        ...
        public Builder delegate(HeaderDecorationDelegate delegate){
            this.delegate = delegate;
            return this;
        }
...
//            mView.requestFocus();
        ...
        public HeaderDecoration build() {
            ...
            return new HeaderDecoration(mView, mHorizontal, mParallax, mShadowSize * 1.5f, mColumns, delegate);
        }
